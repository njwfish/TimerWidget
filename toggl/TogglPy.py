...
class Toggl():
    ...
    def decodeJSON(self, jsonString):
        return json.JSONDecoder().decode(jsonString.decode('utf-8'))
    ...
    def setAPIKey(self, APIKey):
        ...
        authHeader = codecs.encode(bytes(authHeader, 'utf-8'), 'base64_codec').rstrip()
        authHeader = "Basic " + authHeader.decode('utf-8')
    ...
    def requestRaw(self, endpoint, parameters=None):
        ...
        if parameters == None:
            ...
            endpoint = endpoint + "?" + urllib.urlencode(
    ...
    def postRequest(self, endpoint, parameters=None):
        ...
        if parameters == None:
            ...
            return urllib.request.urlopen(urllib.request.Request(endpoint, data=data.encode('utf-8'),
